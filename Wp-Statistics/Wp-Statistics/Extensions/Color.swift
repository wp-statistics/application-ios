...
//  Chang
//
//  Created by Kambiz on 2023-12-27.
//
...
struct ColorTheme {
    ...
    let orangColor = Color(#colorLiteral(red: 0.9960784314, green: 0.4784313725, blue: 0.007843137255, alpha: 1))
    let shapeColor = Color(#colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1))
}


struct ColorTheme2 {
    let accent = Color(#colorLiteral(red: 0, green: 0.9921568627, blue: 1, alpha: 1))
